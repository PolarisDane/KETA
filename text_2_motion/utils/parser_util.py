...
def add_model_options(parser):
    ...
    group.add_argument("--lambda_text_kp_align", default=0.0, type=float, help="Text kp align loss")
    group.add_argument("--unconstrained", action='store_true',
                       help="Model is trained unconditionally. That is, it is constrained by neither text nor action. "
                            "Currently tested on HumanAct12 only.")
    group.add_argument('--config', type=str, default="./config/model.yaml")
    group.add_argument('--align-model-dir', type=str, default="./save/my_gaussian_6_all")
    group.add_argument('--align-model-ckpt', type=str, default="./save/my_gaussian_6_all/align_model_250.pth")
    group.add_argument('--text-encoder-type', type=str, default="clip")
    group.add_argument('--use_guide_token', type=bool, default=False)
